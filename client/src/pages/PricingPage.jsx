    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link to="/verify" className="text-gray-600 hover:text-gray-900 transition duration-200 font-medium">
                Verificar
              </Link>
              <Link to="/login" className="text-gray-600 hover:text-gray-900 transition duration-200 font-medium">
                Iniciar Sesión
              </Link>
              <Link
                to="/login"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-32">
        <header className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Planes de Servicio de EcoSign.app</h1>
                    ...
                    <li key={idx} className="flex items-start text-sm">
                      ...
                      <div className="flex-1">
                        ...
                        {feature.value !== true && feature.value !== false && (
                          <span className="text-gray-900 ml-1">{feature.value}</span>
                        )}
                      </div>
                    </li>
                  ))}
        ...
        <div className="bg-gray-50 p-8 md:p-12 rounded-2xl border border-gray-200 mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Comparativa Detallada de Características</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b-2 border-gray-300">
                  <th className="p-4 text-gray-900 font-bold">Característica</th>
                  <th className="p-4 text-center text-gray-900 font-bold">FREE</th>
                  <th className="p-4 text-center text-gray-900 font-bold bg-gray-100">PRO</th>
                  <th className="p-4 text-center text-gray-900 font-bold">BUSINESS</th>
                  <th className="p-4 text-center text-gray-900 font-bold">ENTERPRISE</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="p-4 font-medium text-gray-900">Precio Mensual</td>
                ...
                <tr className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="p-4 font-medium text-gray-900">Valor Real del Plan</td>
        ...
        <div className="bg-white p-8 md:p-12 rounded-2xl border-2 border-gray-200 mb-12">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">¿Qué incluye la promoción de lanzamiento del plan PRO?</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">¿Qué es la Firma EcoSign y en qué se diferencia de SignNow?</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">¿Qué es el Blindaje Forense?</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">¿Puedo cambiar de plan en cualquier momento?</h3>
              <p className="text-gray-700 leading-relaxed">
        ...
        <div className="text-center text-gray-600 mb-8">
          <p>¿Tienes preguntas? <a href="mailto:contact@ecosign.app" className="text-gray-900 hover:text-gray-700 font-semibold underline">Contáctanos</a> para una demostración personalizada.</p>
        </div>
      </div>
