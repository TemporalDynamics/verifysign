    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-10">
        <div className="text-center">
          <p className="text-xs font-semibold tracking-[0.3em] text-gray-500 mb-3">PLANES INTERNOS</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {plans.map((plan) => (
            <div key={plan.name} className={`relative bg-white rounded-2xl shadow-lg border ${plan.popular ? 'border-gray-900' : 'border-gray-200'}`}>
              {plan.popular && (
              ...
              <div className="p-8">
                ...
                <p className="text-4xl font-bold text-gray-900 mb-3">{plan.price}</p>
                ...
                <button className={`w-full py-3 rounded-lg font-semibold ${plan.popular ? 'bg-gray-900 hover:bg-gray-800 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-900'}`}>
                  {plan.button}
                </button>
              </div>
            </div>
